...
class BDENTAL_Props(bpy.types.PropertyGroup):
    ...
    slices_brightness: FloatProperty(
        description="Slices Brightness ", default=0.5, step=1, precision=3, update=brightness_update
    )
    slices_contrast: FloatProperty(
        description="Slices Contrast ", default=1.2, step=1, precision=3, update=contrast_update
    )
